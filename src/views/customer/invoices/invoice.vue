                                        ...
                                        <table width="100%" style="padding: 20px 20px;">
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="font-size:12px;color:#000;">362 Bonnet Ave</p>
                                                    <p style="font-size:12px;color:#000;">Austin, TX 78742</p>
                                                </td>
                                        ...
                                        <table width="100%" style="padding: 20px 20px;">
                                            <tr>
                                                ...
                                                <td style="text-align:right;">
                                                    ...
                                                    <p style="font-size:12px;color:#000;">Issued: 10/08/2023 </p>
