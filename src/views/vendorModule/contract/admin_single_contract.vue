  ...
  try {
    ...
    const response = await axios.post(`/home/single_contract`, formData, config);
        if(response.data.contract_data){
            ...
            start_date.value = formatDate(contract.seldate)
            end_date.value = formatDate(contract.updated_at)
...
async function edit_contract() {
  try {
    ...
    if (vendor.value || admin.value){
        ...
        console.log(contract_role.value,"contract_role.value")

        if((admin.value =='admin') && (contract_role.value == 'vendor')){
            console.log("admin sign ????????????????????????")
            formData.append("vendor_sign",vendor_sign.value);
            formData.append("v_signature",signature_imge.value);
            formData.append("user_current_role",'vendor');
            formData.append("check_change",'Admin_Chnage_VendorSigntoCouple');
...
const generateSignaturea = () => {
    ...
    const totalTextWidth = adminName.value
        .split('')
        .reduce((width, char) => width + ctx.measureText(char).width, 0);
    ...
    for (let i = 0; i < adminName.value.length; i++) {
        ctx.fillText(adminName.value[i], startX, canvas.height / 2);
        startX += ctx.measureText(adminName.value[i]).width + randomLetterSpacing;
    }
                ...
                <v-card-item class="py-10">
                    <div  id="download_contract" ref="contract">
                        <div class="contract">
                            ...
                            <p class="text-body-1 text-13 font-weight-regular mb-1">b. The services will be provided on <strong><u>{{start_date}}</u></strong> at <strong><u>{{location}}</u></strong>.
                            </p>
                            ...
                            <p class="text-body-1 text-13 font-weight-regular mb-1">b. Payment Schedule:</p>
                                ...
                                <div v-if="retainer">
                                    <h2 v-if="retainer != 'undefined'" class="text-h6 mb-2">Retainer</h2>
                                ...
                                <div v-if="contracted_services">
                                    <h2 v-if="contracted_services != 'undefined'" class="text-h6 mb-2">Contracted services </h2>
                                ...
                                <div v-if="expiration">
                                    <h2 v-if="expiration != 'undefined'" class="text-h6 mb-2">Expiration</h2>
                                ...
                                <div v-if="documentation">
                                    <h2 v-if="documentation != 'undefined'" class="text-h6 mb-2">Provided Documentation</h2>
                                ...
                                <div v-if="hotel_accommodations"> 
                                    <h2 v-if="hotel_accommodations != 'undefined'" class="text-h6 mb-2">Hotel Accommodations</h2>
                                ...
                                <div v-if="destination"> 
                                    <h2 v-if="destination != 'undefined'" class="text-h6 mb-2">Destination</h2>
                                ...
                                <div v-if="attire"> 
                                    <h2 v-if="attire != 'undefined'" class="text-h6 mb-2">Attire</h2>
                                ...
                                <div v-if="liability"> 
                                    <h2 v-if="liability != 'undefined'" class="text-h6 mb-2">Liability</h2>
                                ...
                                <div v-if="cancellation_policy"> 
                                    <h2 v-if="cancellation_policy != 'undefined'" class="text-h6 mb-2">Cancellation Policy</h2>
                                ...
                                <div v-if="postponement_policy"> 
                                    <h2 v-if="postponement_policy != 'undefined'" class="text-h6 mb-2">Postponement Policy</h2>
                                ...
                                <div v-if="responsibility"> 
                                    <h2 v-if="responsibility != 'undefined'" class="text-h6 mb-2">Responsibility</h2>
                                ...
                                <div v-if="overtime"> 
                                    <h2 v-if="overtime != 'undefined'" class="text-h6 mb-2">Overtime</h2>
                                ...
                                <div v-if="contracted_vendor_payments"> 
                                    <h2 v-if="contracted_vendor_payments != 'undefined'" class="text-h6 mb-2">Contracted Vendor and Payments</h2>
                                    <p v-if="contracted_vendor_payments != 'undefined'" class="text-body-1 text-13 font-weight-regular mb-5">{{ contracted_vendor_payments }}</p>
                                </div>

                                <div v-if="damage_loss_accessories"> 
                                    <h2 v-if="damage_loss_accessories != 'undefined'" class="text-h6 mb-2">Damage or Loss of Accessories</h2>
                                ...
                                <div v-if="schedule_method"> 
                                    <h2 v-if="schedule_method != 'undefined'" class="text-h6 mb-2">Payment Schedule and Method</h2>
                                    <p v-if="schedule_method != 'undefined'" class="text-body-1 text-13 font-weight-regular mb-5">
                                        {{ schedule_method }}
                                    </p>
                                </div>
                                <div v-if="attorney"> 
                                    <h2 v-if="attorney != 'undefined'" class="text-h6 mb-2">Attorney</h2>
                                    <p v-if="attorney != 'undefined'" class="text-body-1 text-13 font-weight-regular mb-5">
                                        {{ attorney }}
                                    </p>
                                </div>
                                <div v-if="appropriate_conduct"> 
                                    <h2 v-if="appropriate_conduct != 'undefined'" class="text-h6 mb-2">Appropriate Conduct/ Safe Working Environment:</h2>
                                ...
                                <h2 class="text-h6 mb-1 mt-5">Additional instructions for agreement:</h2>
                        ...
                        <v-row class="mt-5">
                            <v-col v-if="customer"  cols="12" class="d-flex gap-4">
                                ...
                                <div v-if="signature_imge" class="borderall pa-3 rounded w-50">   
                                    ...
                                    <div>
                                        <div class="border-bottomnew py-3">
                                            <h2 v-if="(contract_role =='couple' || contract_role =='vendor') && (role == 'customer' && contract_users == 'AC')"  class="text-h6 mb-1 ">Admin Name: </h2>
                                            <h2 v-else class="text-h6 mb-1 mt-5">Vendor Name: </h2>
                                            <p  class="text-body-1 text-13 font-weight-regular ">
                                            {{ vendor_name }} 
                                            </p>
                                        </div>
                                        <div class="border-bottomnew py-3">
                                            <div v-if="(contract_role =='couple' || contract_role =='vendor') && (role == 'customer' && contract_users == 'AC')" class="text-h6 mb-3">Admin Signature: </div>
                                            <div v-else class="text-h6 mb-3">Vendor Signature:</div>
                            ...
                            <v-col v-else cols="12" class="d-flex gap-4">
                                <div v-if="signature_imge" class="w-50 borderall pa-3 rounded ">                     
                                    <div>
                                        <div class="border-bottomnew py-3">
                                            <h2 v-if="(contract_role =='couple' || contract_role =='vendor') && (role == 'admin')" class="text-h6 mb-1 ">Admin Name: </h2>
                                            <h2 v-else class="text-h6 mb-1 ">Vendor Name: </h2>
    
                                    
                                            <p v-if="(contract_role =='couple' || contract_role =='vendor') && (role == 'admin' && admin_signature_imge == null)"  class="text-body-1 text-13 font-weight-regular ">
                                                {{ vendor_name }}
                                            </p>
    
    
                                            <p v-else class="text-body-1 text-13 font-weight-regular ">
                                                <template v-if="role == 'vendor'">  {{ vendor_name }}
                                                </template>
                                                <template v-else>  {{ customer_name }}
                                                </template>
                                        ...
                                        <div class="border-bottomnew py-3">
                                            <div v-if="(contract_role =='couple' || contract_role =='vendor') && (role == 'admin' && admin_signature_imge == null)" class="text-h6 mb-3">
                                                Admin Signature: 
                                            </div>
                                ...
                                <div v-else class="w-50">
                                    ...
                                    <div v-if="((contract_role =='couple' || contract_role =='vendor') && ( role == 'admin')&&(contract_users != 'AC') && 
                                        (admin_signature_imge != null) && (contract_users != 'AV')
                                            )" >
                                    </div>
                                    <div v-else class=" borderall pa-3 rounded">
                                    <div class="border-bottomnew py-3">
                                        <h2 v-if="(contract_role =='couple' || contract_role =='vendor') && (role == 'admin')" class="text-h6 mb-1 ">Admin Name:  </h2>
                                    ...
                                    <div class="border-bottomnew py-3 d-flex align-center">
                                        <v-text-field
                                            ...
                                            hide-details
                                        ></v-text-field>
                                        <v-btn color="secondary" size="large" variant="flat" class="rounded-sm ml-3" @click="generateSignaturea">Convert</v-btn> 
                                    </div>
                                    <div class="border-bottomnew py-3">
                                        <div v-if="vendor" class="text-h6  mb-3">Vendor Signature: </div>
                                        <div v-if="(contract_role =='couple' || contract_role =='vendor') && (role == 'admin')" 
                                        class="text-h6 mb-3">Admin Signature: </div>
