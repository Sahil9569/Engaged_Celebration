                ...
                <div class="text-center position-relative">
                    <div class="overflow-hidden rounded-md">
                        <div class="megamenu">
                            ...
                            <v-btn class="bg-primary text-white position-absolute mx-sm-12 pr-3" flat target="_blank"
                                :href="demo.link">Live Preview</v-btn>
                        </div>
                    </div>
                </div>
    ...
    <v-list-group value="Apps">
        ...
        <v-list class="py-0 px-2">
            <v-list-item rounded="md">
                <v-btn variant="text" color="primary" class="custom-hover-primary nav-links" to="/">Home</v-btn>
            </v-list-item>
            <v-list-item rounded="md">
                <v-btn variant="text" color="primary" class="custom-hover-primary nav-links"
                    to="/customer">For Couple</v-btn>
            </v-list-item>
            <v-list-item rounded="md">
                <v-btn variant="text" color="primary" class="custom-hover-primary nav-links"
                    to="/for-vendor">For Vendor</v-btn>
            </v-list-item>
            <v-list-item rounded="md">
                <v-btn variant="text" color="primary" class="custom-hover-primary nav-links" to="/how-it-works">How it
                    Works</v-btn>
            </v-list-item>
            <v-list-item rounded="md">
                <v-btn variant="text" color="primary" class="custom-hover-primary nav-links" to="/faq">FAQ</v-btn>
            </v-list-item>
            <v-list-item rounded="md">
                <v-btn variant="text" color="primary" class="custom-hover-primary nav-links"
            ...
            <v-list-item class="mt-2" rounded="md">
                <v-btn class="custom-hover-primary bg-secondary" block flat href="/login">Sign In</v-btn>
            </v-list-item>
        </v-list>
    </div>
</template>
