            ...
            <v-row>
                <v-col cols="12 py-0 pt-12">
                    <div class="text-center">
                        <span class="text-secondary about_heading font-weight-bold">Top Category</span>
                        <h2 class="ctm_h2 vendor-t sailFont font-weight-bold ri-font-size-2 text-center mb-5">Let's Plan Your Perfect <span
                                class="">Wedding</span></h2>
                    </div>
                </v-col>
            </v-row>
            <v-row>
                <div class="v-col v-col-12 position-relative" bis_skin_checked="1">
                    ...
                    <v-row class="planColsSet">
                        <v-col v-for="(card, index) in userReview" :key="card.img" cols="4" class="px-8">
                            <div  class="vendor_category">
                                <router-link to="/vendor-single-category" class="w-100 text-decoration-none position-relative">
                                    <div class="text-left text-black category_text">
                                        ...
                                        <h4 class="text-no-wrap pt-4 font-weight-semibold text-black">
                                            {{ card.name }}
                                        </h4>
                                        <p class="text-no-wrap categry_para font-weight-semibold text-black">
                                            <!-- ({{ card.vendors }}) -->(10)
                                        </p>
                                    </div>
                                ...
                                <div v-if="index === 1" class="py-7 px-5 mt-4 rounded text-black text-center slogan">
                                    "Explore our curated vendor category, offering a diverse range of services to make your wedding day unforgettable." 
                                    <v-btn class="form-btn w-100 pt-3 view_btn text-black"> <p>View All</p></v-btn>
                                </div>
                            </div>
                        </v-col>
